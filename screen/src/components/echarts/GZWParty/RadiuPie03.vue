...
-->
<template>
  <div class="RadiuPieThird" ref="RadiuPieThird"></div>
</template>
<script>
...
export default {
  ...
  methods: {
    drawLineCustom(obj) {
      var myChart = this.$echarts.init(this.$refs.RadiuPieThird)
      let option = {
        title: {
        ...
        color: ['#CE4542', '#CCCE42', '#42BCCE', '#2260D5', '#8F22D5'],
        legend: {
          show: true,
          x: 'center',
          padding: [290, 0, 0, 0],
        ...
        series: [
          {
            ...
            data: obj.data
              ? obj.data
              : [
                { value: 4166, name: '成员任免' },
                { value: 2017, name: '成员解聘' },
                { value: 2017, name: '推荐董事会成员' },
                { value: 4166, name: '领导班子成员解聘' },
                { value: 2017, name: '领导班子成员任免' },
              ],
          },
        ],
      }
