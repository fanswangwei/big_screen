...
-->
<template>
  <div class="RadiuPieFourth" ref="RadiuPieFourth"></div>
</template>
<script>
...
export default {
  ...
  methods: {
    drawLineCustom(obj) {
      var myChart = this.$echarts.init(this.$refs.RadiuPieFourth)
      let option = {
        title: {
        ...
        color: ['#21CED9', '#D99221', '#216BD9', '#F03C83', '#7C3CF0'],
        legend: {
          show: false,
        },
        series: [
          {
            ...
            data: obj.data
              ...
              : [
                ...
                { value: 4166, name: '成员解聘' },
                { value: 2017, name: '成员任免' },
              ],
          },
        ],
      }
