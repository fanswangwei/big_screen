...
-->
<template>
  <div class="RadiuPieTenth" ref="RadiuPieTenth"></div>
</template>
<script>
...
export default {
  ...
  methods: {
    drawLineCustom(obj) {
      var myChart = this.$echarts.init(this.$refs.RadiuPieTenth)
      let option = {
        title: {
        ...
        series: [
          {
            ...
            data: obj.data
              ? obj.data
              : [
                { value: 4166, name: '制度文件异常1' },
                { value: 4166, name: '出席人员异常2' },
                { value: 2017, name: '党委会未前置异常3' },
                { value: 4166, name: '决策链顺序异常4' },
                { value: 4166, name: '决策链断裂异常5' },
                { value: 2017, name: '议题表决异常6' },
                { value: 4166, name: '合法性审查异常7' },
                { value: 4166, name: '合规性审查异常8' },
              ],
          },
        ],
      }
