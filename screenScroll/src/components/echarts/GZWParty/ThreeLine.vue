    ...
    drawLineCustom(obj) {
      ...
      let option = {
        ...
        xAxis: {
          ...
          data: obj.xData ? obj.xData : ['2015', '2016', '2017', '2018', '2019', '2020', '2021'],
        },
        yAxis: {
          type: 'value',
          splitLine: {
        ...
        series: [
          {
            ...
            data: obj.yData[0].value ? obj.yData[0].value : [120, 132, 101, 134, 90, 230, 210],
          },
          {
            name: '优秀党务工作者',
            type: 'line',
            ...
            data: obj.yData[1].value ? obj.yData[1].value : [220, 182, 191, 234, 290, 330, 310],
          },
          {
            name: '先进基层党组织',
            type: 'line',
            ...
            data: obj.yData[2].value ? obj.yData[2].value : [150, 232, 201, 154, 190, 330, 410],
          },
        ],
      }
