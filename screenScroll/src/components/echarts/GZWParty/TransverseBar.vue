          ...
          series: [
            {
              ...
              data: obj.yData[0].value ? obj.yData[0].value : [320, 302, 301, 334, 390, 330, 320],
            },
            {
              name: '文化名人',
              type: 'bar',
              ...
              data: obj.yData[1].value ? obj.yData[1].value : [120, 132, 101, 134, 90, 230, 210],
            },
            {
              name: '青少年成长',
              type: 'bar',
              ...
              data: obj.yData[2].value ? obj.yData[2].value : [220, 182, 191, 234, 290, 330, 310],
            },
          ],
        },
        true
